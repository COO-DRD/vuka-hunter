    ...
    <div className="min-h-screen flex" style={{ background: "#F8F7F4" }}>
      ...
      <div className="hidden lg:flex lg:w-[460px] xl:w-[500px] shrink-0 flex-col justify-between px-10 py-10 relative overflow-hidden"
        ...
        <div className="relative z-10 space-y-7">
          <div>
            <h1 className="text-4xl font-black leading-tight" style={{ color: "#0C0C0C" }}>
              Your next client<br />
              <span className="text-brand-gradient">is already online.</span><br />
        ...
        <div className="relative z-10">
          ...
          <p className="text-xs mt-0.5" style={{ color: "#AAA" }}>Free 7-day trial · No credit card needed</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 overflow-y-auto"
        ...
        <div className="w-full max-w-[380px]">
          ...
          {/* Heading */}
          <div className="mb-7">
            <h2 className="text-2xl font-black" style={{ color: "#0C0C0C" }}>Create your account</h2>
            <p className="text-sm mt-1" style={{ color: "#6B6B6B" }}>7-day free trial · No credit card needed.</p>
          </div>
