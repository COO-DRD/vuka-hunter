    ...
    <div className="min-h-screen flex bg-[#F8F7F4]">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-xs text-stone-400 mt-0.5">Free Trial — 7 days · No credit card needed</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-10 overflow-y-auto bg-white">
        ...
        <div className="w-full max-w-sm">
          <div className="mb-6">
            <h2 className="text-2xl font-black text-stone-950">Create your account</h2>
            <p className="text-sm text-stone-500 mt-1">7-day free trial · No credit card needed.</p>
          </div>
