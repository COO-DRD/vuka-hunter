        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-orange-500/20 bg-orange-500/10 px-3 py-1">
              ...
              <span className="text-xs font-medium text-orange-400">Free Workshop</span>
            </div>
            ...
            <div className="rounded-xl border border-zinc-800 bg-zinc-900/60 p-4 flex items-start gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-red-500 to-orange-500">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full rounded-md border border-zinc-700 bg-zinc-800 px-3 py-2 text-sm text-zinc-100 placeholder-zinc-600 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500/50"
                      />
                    </div>
                    <div className="space-y-1.5">
