    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
        ...
        <div className="flex flex-col gap-12 lg:flex-row lg:items-center">
          ...
          <div className="flex-1 space-y-6 lg:max-w-xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-amber-500/25 bg-amber-500/10 px-3 py-1">
              ...
              <span className="text-xs font-medium text-amber-400">10× pipeline productivity · Kenya</span>
            </div>
            ...
            <p className="text-lg text-zinc-400 leading-relaxed">
              Hunter finds, qualifies, and writes the opener for 100 Kenyan businesses before
              your competitor finishes their first Google search. Every lead is scored, enriched,
              and ready to close.
            </p>
        ...
        <div className="mx-auto max-w-6xl px-4 py-6">
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 text-center">
            {[
              ...
              <div key={label}>
                <div className="text-2xl font-black text-amber-400 tracking-tight">{value}</div>
            ...
            {[
              {
                ...
                step: "01",
                title: "Discover",
                body: "Pull 200 qualified Kenyan businesses per run across multiple data sources. Strict quality protocol — only rated, reviewed businesses make it through.",
              ...
              },
              {
                ...
                step: "02",
                title: "Enrich",
                body: "Crawl each website for emails, booking systems, live chat, and decision-maker contacts. Every gap becomes a sales angle.",
                color: "text-blue-400",
              },
              {
                icon: Zap,
                step: "03",
                title: "Score",
                body: "AI rates every lead 0–100 and surfaces the exact pain signal. Know in 2 seconds which business is worth your next call.",
              ...
              },
              {
                ...
                step: "04",
                title: "Outreach",
                body: "One-click WhatsApp or email opener — written with that specific lead's real pain, not a generic template you edit for an hour.",
      ...
      <section className="mx-auto max-w-6xl px-4 py-20 text-center">
        <h2 className="text-3xl font-black text-zinc-50 sm:text-4xl">
          Your competitor is still on Google.<br />
          <span className="text-brand-gradient">You&apos;re already closing.</span>
        </h2>
        <p className="mt-3 text-zinc-500">
          7-day free trial · No credit card · Nairobi, Mombasa & beyond
        </p>
